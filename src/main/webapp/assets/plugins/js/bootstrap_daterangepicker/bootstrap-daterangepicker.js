    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><em class="fa fa-arrow-left icon icon-arrow-left glyphicon glyphicon-arrow-left"></em></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><em class="fa fa-arrow-right icon icon-arrow-right glyphicon glyphicon-arrow-right"></em></th>';
            } else {
                html += '<th></th>';
            }
