...
(function($){
    ...
    $.fn.tagEditor = function(options, val, blur){
        ...
        if (typeof options == 'string') {
            ...
            selector.each(function(){
                ...
                if (options == 'getTags')
                    ...
                    // insert new tag
                    $('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag"></div><div class="tag-editor-delete"><em></em></div></li>').appendTo(ed).find('.tag-editor-tag')
        ...
        return selector.each(function(){
            ...
            // markup for new tag
            var new_tag = '<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag"></div><div class="tag-editor-delete"><em></em></div></li>';
            ...
            function split_cleanup(input){
                ...
                for (var i=0; i<sub_tags.length; i++) {
                    ...
                    old_tags.push(tag);
                    li.before('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+escape(tag)+'</div><div class="tag-editor-delete"><em></em></div></li>');
            ...
            for (var i=0; i<tags.length; i++) {
                ...
                if (tag) {
                    if (o.forceLowercase) tag = tag.toLowerCase();
                    tag_list.push(tag);
                    ed.append('<li><div class="tag-editor-spacer">&nbsp;'+o.delimiter[0]+'</div><div class="tag-editor-tag">'+escape(tag)+'</div><div class="tag-editor-delete"><em></em></div></li>');
                }
            }
